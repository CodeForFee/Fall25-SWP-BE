...
public class VehicleTypeController {
    ...
    public ResponseEntity<VehicleTypeResponse> getVehicleTypeById(@PathVariable Integer id) {
        return ResponseEntity.ok(vehicleTypeService.getById(id));
    }

    @PostMapping
    @Operation(summary = "Tạo vehicle type mới")
    public ResponseEntity<VehicleTypeResponse> createVehicleType(@RequestBody VehicleTypeRequest req) {
        return ResponseEntity.ok(vehicleTypeService.create(req));
    }

    @PutMapping("/{id}")
    @Operation(summary = "Cập nhật vehicle type")
    public ResponseEntity<VehicleTypeResponse> updateVehicleType(@PathVariable Integer id, @RequestBody VehicleTypeRequest req) {
