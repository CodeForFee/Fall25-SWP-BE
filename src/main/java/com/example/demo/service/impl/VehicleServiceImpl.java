...
public class VehicleServiceImpl implements VehicleService {
    ...
    @Override
    public VehicleResponseDTO update(Integer id, VehicleDTO req) {
    ...
    @Override
    public VehicleResponseDTO updatePriceAndConfig(Integer id, Double price, String specificationsJson) {
        Vehicle v = repo.findById(id).orElseThrow(() -> new ResourceNotFoundException("Vehicle not found"));
    ...
    @Override
    public VehicleResponseDTO updateVersionsAndColors(Integer id, String versionJson, String colorsJson) {
        Vehicle v = repo.findById(id).orElseThrow(() -> new ResourceNotFoundException("Vehicle not found"));
